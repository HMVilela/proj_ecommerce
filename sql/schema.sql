...
INSERT INTO tblGame(id, name, description, currentValue, availability, category, console, photoLink) 
VALUES(2, 'Final Fantasy XIV', 'Description 02', 190.00, 'AVAILABLE', 'MMORPG', 'PS4', 'css/img/finalFantasyXIV.png');
INSERT INTO tblGame(id, name, description, currentValue, availability, category, console, photoLink) 
VALUES(3, 'The Last of Us', 'Description 03', 120.00, 'AVAILABLE', 'SURVIVAL', 'PS4', 'css/img/theLastOfUs.png');
INSERT INTO tblGame(id, name, description, currentValue, availability, category, console, photoLink) 
VALUES(4, 'Mortal Kombat X', 'Description 04', 210.00, 'AVAILABLE', 'FIGHT', 'PS4', 'css/img/mortalKombatX.png');
INSERT INTO tblGame(id, name, description, currentValue, availability, category, console, photoLink) 
VALUES(5, 'Ultra Street Fighter IV', 'Description 05', 140.00, 'AVAILABLE', 'FIGHT', 'PS4', 'css/img/ultrStreetFighterIV.png');
INSERT INTO tblGame(id, name, description, currentValue, availability, category, console, photoLink) 
VALUES(6, 'Shadow of Mordor', 'Description 06', 190.00, 'AVAILABLE', 'RPG', 'PS4', 'css/img/shadowOfMordor.png');
INSERT INTO tblGame(id, name, description, currentValue, availability, category, console, photoLink) 
VALUES(7, 'Dying Light', 'Description 07', 199.00, 'AVAILABLE', 'SURVIVAL', 'PS4', 'css/img/dyingLight.png');
INSERT INTO tblGame(id, name, description, currentValue, availability, category, console, photoLink) 
VALUES(8, 'Battlefield: Hardline', 'Description 08', 140.00, 'AVAILABLE', 'SHOOTER', 'PS4', 'css/img/battlefieldHardline.png');
INSERT INTO tblGame(id, name, description, currentValue, availability, category, console, photoLink) 
VALUES(9, 'Destiny', 'Description 09', 170.00, 'AVAILABLE', 'SHOOTER', 'PS4', 'css/img/destiny.png');
INSERT INTO tblGame(id, name, description, currentValue, availability, category, console, photoLink) 
VALUES(10, 'Tekken V', 'Description 10', 130.00, 'AVAILABLE', 'FIGHT', 'PS3', 'css/img/tekkenV.png');
INSERT INTO tblGame(id, name, description, currentValue, availability, category, console, photoLink) 
VALUES(11, 'Need for Speed: Most Wanted', 'Description 11', 50.00, 'AVAILABLE', 'RUNNER', 'PS2', 'css/img/needForSpeedMostWanted.png');
INSERT INTO tblGame(id, name, description, currentValue, availability, category, console, photoLink) 
VALUES(12, 'Gran Turismo', 'Description 12', 40.00, 'AVAILABLE', 'RUNNER', 'PS1', 'css/img/granTurismo.png');
